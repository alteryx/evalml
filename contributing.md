...
* Update the "Future Release" section at the top of the changelog (`docs/source/release_notes.rst`) to include an entry for your pull request. Write your entry in past tense, i.e. "added fizzbuzz impl."
