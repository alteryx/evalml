...
def _convert_sampler_dataset(X, y, to_pandas=True, numeric=True):
    """Convert sampler data to woodwork or pandas datatype. If numeric is True, raises ValueError if there is null or non-numeric data.
    ...
    if numeric and not is_all_numeric(X_ww):
