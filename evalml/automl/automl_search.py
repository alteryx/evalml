...
class AutoMLSearch:
    ...
    def __init__(
        ...
        if is_time_series(problem_type):
            if "DatetimeFeaturizer" in exclude_featurizers and "TimeSeriesFeaturizer" not in exclude_featurizers:
                raise ValueError("For time series problems, if DatetimeFeaturizer is excluded, must also exclude TimeSeriesFeaturizer")
            elif "TimeSeriesFeaturizer" in exclude_featurizers and "DatetimeFeaturizer" not in exclude_featurizers:
                raise ValueError("For time series problems, if TimeSeriesFeaturizer is excluded, must also exclude DatetimeFeaturizer")
