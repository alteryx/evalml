...
class AutoMLAlgorithm(ABC):
    ...
    allowed_pipelines : list(PipelineBase)
        A list of PipelineBase subclasses indicating the pipelines allowed in the search. The default of None indicates all pipelines for this problem type are allowed.
    custom_hyperparameters : dict
        Custom hyperparameter ranges specified for pipelines to iterate over.
    max_iterations : int
