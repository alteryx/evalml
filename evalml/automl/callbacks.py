...
def log_and_save_error_callback(exception, automl, **kwargs):
...
def raise_and_save_error_callback(exception, automl, **kwargs):
...
def log_error_callback(exception, automl, **kwargs):
