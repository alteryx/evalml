...
class BaseSamplingSplitter(BaseCrossValidator):
    ...
    def __init__(self, sampler=None, test_size=None, n_splits=3, shuffle=True, split_type="CV", random_seed=0):
        ...
        Arguments:
            ...
            split_type (str): Whether to use TV or CV split. Defaults to CV.
