...
class LightGBMClassifier(Estimator):
    ...
    def __init__(self, boosting_type="gbdt", learning_rate=0.1, n_estimators=10, max_depth=0, num_leaves=31, min_child_samples=20, n_jobs=-1, random_state=0, bagging_fraction=0.9, bagging_freq=0, **kwargs):
