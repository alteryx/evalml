...
class PipelineBase:
    ...
    def __init__(self, objective, component_list, n_jobs, random_state, problem_type):
        ...
        if self.problem_type not in self.problem_types:
            raise ValueError("Inputted problem type {} is not valid for {}. Valid problem_types include {}".format(problem_type, self.name, self.problem_types))
