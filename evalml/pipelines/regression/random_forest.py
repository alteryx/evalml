...
class RFRegressionPipeline(PipelineBase):
    ...
    def feature_importances(self):
        ...
        importances = list(zip(feature_names, self.pipeline.get_component("Random Forest Regressor")._component_obj.feature_importances_))  # note: this only works for binary
