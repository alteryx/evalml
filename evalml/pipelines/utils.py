...
def _make_stacked_ensemble_pipeline(input_pipelines, problem_type, data_splitter=None, n_jobs=-1, random_state=0):
    """
    ...
    if problem_type in [ProblemTypes.BINARY, ProblemTypes.MULTICLASS]:
        ...
        return make_pipeline_from_components([StackedEnsembleRegressor(input_pipelines, n_jobs=n_jobs, cv=data_splitter)], problem_type,
