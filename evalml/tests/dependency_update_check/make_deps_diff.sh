reqs_list=$(python -c "import os; import sys; import io; save_stdout = sys.stdout; sys.stdout = open('output', 'w'); from evalml.utils import get_evalml_pip_requirements; sys.stdout = save_stdout; print('\n'.join(get_evalml_pip_requirements(os.getcwd())));")
