...
def test_transform_parameters():
    ...
    parameters_dict = {
        ...
        'One Hot Encoder': {},
        'Standard Scaler': {},
        'Logistic Regression Classifier': {'penalty': 'l2', 'C': 8.444214828324364}
    }
    assert automl._transform_parameters(LogisticRegressionPipeline, parameters) == parameters_dict
