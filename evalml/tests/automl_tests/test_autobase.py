...
def test_automl_str_search(mock_fit, X_y):
    ...
    search_params = {
        ...
        'patience': 2,
        'tolerance': 0.5,
        'allowed_model_families': ['random_forest', 'linear_model', 'extra_trees'],
    ...
    param_str_reps = {
        ...
        'Possible Pipelines': ['Random Forest Binary Classification Pipeline', 'Logistic Regression Binary Pipeline', 'Extra Trees Binary Classification Pipeline'],
