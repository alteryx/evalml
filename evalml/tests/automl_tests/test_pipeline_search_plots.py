...
def test_generate_roc(X_y):
    ...
    pipeline = LogisticRegressionPipeline(objective="ROC", penalty='l2', C=0.5, impute_strategy='mean', number_features=len(X[0]), random_state=1)
    results = {}
    cv_data = []
    ...
    search_plots = PipelineSearchPlots(results)
