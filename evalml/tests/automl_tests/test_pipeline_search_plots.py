...
def test_search_iteration_plot_class():
    ...
    class MockResults:
        def __init__(self):
            ...
            self.results = {
                "pipeline_results": {
                    2: {"mean_cv_score": 0.75, "ranking_score": 0.50},
                    0: {"mean_cv_score": 0.50, "ranking_score": 0.60},
                    1: {"mean_cv_score": 0.60, "ranking_score": 0.75},
                },
                "search_order": [1, 2, 0],
            }
            self.rankings = pd.DataFrame({"ranking_score": [0.75, 0.60, 0.50]})
