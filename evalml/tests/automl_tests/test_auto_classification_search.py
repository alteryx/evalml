...
def test_init(X_y):
    ...
    assert get_pipelines(problem_type=ProblemTypes.BINARY) == automl.possible_component_lists
...
def test_init_select_model_types():
    ...
    assert get_pipelines(problem_type=ProblemTypes.BINARY, model_types=model_types) == automl.possible_component_lists
