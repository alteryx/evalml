...
cases = [(all_distinct_X, all_distinct_y, True, {"warnings": [], "errors": [], "actions": []}),
         ...
         (all_null_X, all_distinct_y, False, {"warnings": [], "errors": [feature_0_unique], "actions": []}),
         (all_null_X, [1] * 4, False, {"warnings": [], "errors": [feature_0_unique, labels_1_unique], "actions": []}),
         (all_null_X, all_distinct_y, True, {"warnings": [], "errors": [feature_1_unique], "actions": []}),
         ...
         (two_distinct_with_nulls_X, two_distinct_with_nulls_y, True,
          {"warnings": [DataCheckWarning(message="feature has two unique values including nulls. Consider encoding the nulls for "
           ...
           "errors": [],
           "actions": []}),
         (two_distinct_with_nulls_X, two_distinct_with_nulls_y, False, {"warnings": [], "errors": [feature_1_unique, labels_1_unique], "actions": []}),
