...
def test_outliers_data_check_warnings():
    ...
    outliers_check = OutliersDataCheck()
    assert outliers_check.validate(X) == DataCheckResults(warnings=[DataCheckWarning("Column '3' is likely to have outlier data", "OutliersDataCheck"),
...
def test_outliers_data_check_input_formats():
    ...
    assert outliers_check.validate(pd.DataFrame()) == DataCheckResults()
    ...
    outliers_check = OutliersDataCheck()
    assert outliers_check.validate(X.to_numpy()) == DataCheckResults(warnings=[DataCheckWarning("Column '3' is likely to have outlier data", "OutliersDataCheck"),
                                                                               DataCheckWarning("Column '25' is likely to have outlier data", "OutliersDataCheck"),
                                                                               DataCheckWarning("Column '55' is likely to have outlier data", "OutliersDataCheck"),
                                                                               DataCheckWarning("Column '72' is likely to have outlier data", "OutliersDataCheck")])
...
def test_outliers_data_check_string_cols():
    ...
    outliers_check = OutliersDataCheck()
    assert outliers_check.validate(X) == DataCheckResults(warnings=[DataCheckWarning("Column 'd' is likely to have outlier data", "OutliersDataCheck")])
