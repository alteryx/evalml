...
def test_target_leakage_data_check_warnings():
    ...
    assert leakage_check.validate(X, y) == {
        ...
        "errors": [],
        "actions": [DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'a'}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'b'}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'c'}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'd'}).to_dict()]
    }
...
def test_target_leakage_data_check_input_formats():
    ...
    assert leakage_check.validate(X.to_numpy().astype(float), y) == {
        ...
        "errors": [],
        "actions": [DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 0}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 1}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 2}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 3}).to_dict()]
    }
...
def test_target_leakage_regression():
    ...
    expected = {
        ...
        "actions": [DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'a'}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'b'}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'c'}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'e'}).to_dict()]
    }
