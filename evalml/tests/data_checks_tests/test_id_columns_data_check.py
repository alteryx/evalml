...
def test_id_columns_warning():
    ...
    assert id_cols_check.validate(X) == {
        ...
        "errors": [],
        "actions": [DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": "Id"}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": "col_1_id"}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": "col_2"}).to_dict(),
                    DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": "col_3_id"}).to_dict()]
    }
