...
def test_highly_null_data_check_warnings():
    ...
    assert no_null_check.validate(data) == {
        "warnings": [DataCheckWarning("Column 'lots_of_null' is more than 0% null", "HighlyNullDataCheck"),
    ...
    assert some_null_check.validate(data) == {
        "warnings": [DataCheckWarning("Column 'lots_of_null' is 50.0% or more null", "HighlyNullDataCheck"),
    ...
    assert all_null_check.validate(data) == {
        "warnings": [DataCheckWarning("Column 'all_null' is 100.0% or more null", "HighlyNullDataCheck")],
        "errors": []
    }
...
def test_highly_null_data_check_input_formats():
    ...
    assert highly_null_check.validate([None, None, None, None, 5]) == {
        "warnings": [DataCheckWarning("Column '0' is 80.0% or more null", "HighlyNullDataCheck")],
        "errors": []
    }
