...
def test_uniqueness_data_check_warnings():
    ...
    assert uniqueness_check.validate(data) == {
        ...
        "errors": [],
        "actions": [DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'regression_not_unique_enough'}).to_dict()]
    }
    ...
    assert uniqueness_check.validate(data) == {
        ...
        "errors": [],
        "actions": [DataCheckAction(DataCheckActionCode.DROP_COL, metadata={"columns": 'multiclass_too_unique'}).to_dict()]
    }
