...
def test_returns_digraph_object():
    clf = PipelineBase('precision', component_graph=['Simple Imputer', 'One Hot Encoder', 'Standard Scaler', 'Logistic Regression Classifier'], parameters={})
    plot = clf.plot()
...
def test_saving_png_file(tmpdir):
    ...
    pipeline = PipelineBase('precision', component_graph=['Simple Imputer', 'One Hot Encoder', 'Standard Scaler', 'Logistic Regression Classifier'], parameters={)
