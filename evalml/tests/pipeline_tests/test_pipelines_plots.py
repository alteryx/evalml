...
def test_returns_digraph_object():
    clf = PipelineBase('precision', component_list=['Simple Imputer', 'One Hot Encoder', 'Standard Scaler', 'Logistic Regression Classifier'],
...
def test_saving_png_file(tmpdir):
    ...
    pipeline = PipelineBase('precision', component_list=['Simple Imputer', 'One Hot Encoder', 'Standard Scaler', 'Logistic Regression Classifier'],
                            n_jobs=-1, random_state=0, problem_type='binary')
